      ...
      <Card>
        ...
        <CardContent className="space-y-4">
             <div className="prose prose-sm prose-invert max-w-none text-muted-foreground">
                ...
                <p>EQPMGR uses a simple usage-based billing model designed to scale with your business:</p>
                <ul>
            ...
            <div className="rounded-lg border border-border p-4 text-center">
                 <Button onClick={handleManageBilling} disabled={billingLoading} variant="ghost" className="h-auto p-0 hover:bg-transparent">
                    {billingLoading ? <Loader2 className="h-8 w-32 animate-spin" /> : (
                        <svg xmlns="http://www.w3.org/2000/svg" width="1200" height="800" viewBox="-22.35 -10.25 193.7 61.5" className="h-10 w-auto">
